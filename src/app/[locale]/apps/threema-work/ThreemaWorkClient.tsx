// src/app/[locale]/apps/threema-work/ThreemaWorkClient.tsx
'use client';
    ...
    <div>
      ...
      <main className='p-5 bg-[#F4F8FA] tracking-wide md:flex md:flex-row-reverse md:justify-center md:items-center md:gap-20 md:py-16 md:bg-white'>
        <div className='w-[85.5%] mx-auto mb-[50px] md:mt-9 md:w-2/4 lg:w-2/5 md:mx-0 xl:w-1/3'>
          <Image
            ...
            alt='threema work secure enterprise messaging banner'
            width={320}
            height={237}
            priority
            className='w-full'
      ...
      <section className='py-[60px] bg-[#F4F8FA] md:pb-0'>
        <div className='flex flex-col text-center mx-5 gap-8 mb-[60px] md:flex-row md:items-center md:justify-center md:mb-[60px] md:py-24 md:pr-20 md:w-[85%] md:leading-tight md:ml-auto md:text-left md:gap-20'>
          <h2 className='text-[24px] lg:text-[44px] md:w-1/2 font-bold'>
          ...
          <Image
            ...
            alt='threema work enterprise messaging demo video'
            width={373}
            height={206}
        ...
        <section className='mt-14 py-10 px-5 bg-white'>
          ...
          <div className='flex flex-col gap-4 md:w-3/4 md:mx-auto'>
            <Accordion title='¿Qué es Threema Work?' />
            <Accordion title='¿Cómo funciona la gestión centralizada?' />
            <Accordion title='¿Qué compatibilidad tiene Threema Work?' />
            <Accordion title='¿Acepta pagos con Bitcoin?' />
            <Accordion title='¿Es compatible con GDPR?' />
          </div>
        </section>
      </section>
    </div>
...
export default ThreemaWorkClient;